...
public class Query_DB{
     ...
     */
    public Query_DB(String login, String password) {
            try { 
				...
				conn = DriverManager.getConnection("jdbc:mysql://https://www.freemysqlhosting.net:3306/sql11172818", login, password);
